                  ...
                  <div className="row d-flex align-items-center">
                    ...
                    <div className="col-md-6 order-last order-md-2">
                      <div className="txt-block left-column wow fadeInRight">
                        ...
                        {/* Text */}
                        <p>
                          Sodales tempor sapien quaerat congue eget ipsum
                          laoreet turpis neque auctor vitae eros dolor luctus
                          placerat magna ligula cursus and purus pretium
                        </p>
                        {/* Small Title */}
                        <h5 className="s-24 w-700 h5-title">
                          The smarter way to work
                        </h5>
                        {/* Text */}
                        <p className="mb-0">
                          Sapien tempor sodales quaerat ipsum undo congue
                          laoreet turpis neque auctor turpis vitae dolor luctus
                          placerat magna and ligula cursus purus vitae
                        </p>
                      </div>
                    </div>{" "}
                    {/* END TEXT BLOCK */}
                  ...
                  <div className="txt-block right-column wow fadeInLeft">
                    ...
                    <div className="txt-box mb-0">
                      ...
                      <p>
                        ...
                        turpis neque auctor turpis vitae dolor luctus placerat
                        magna and ligula cursus purus an ipsum vitae suscipit
                        purus
                      </p>
                      {/* List */}
                      <ul className="simple-list">
              ...
              <div className="row d-flex align-items-center">
                ...
                <div className="col-md-5">
                  <div className="txt-block left-column wow fadeInRight">
                    ...
                    {/* Text */}
                    <p>
                      Sodales tempor sapien quaerat ipsum and congue undo
                      laoreet turpis neque auctor turpis vitae dolor luctus
                      placerat magna ligula and cursus vitae
                    </p>
                    {/* List */}
                    <ul className="simple-list">
                      <li className="list-item">
                    ...
                    <div className="col-md-11 col-lg-9">
                      <div className="section-title wow fadeInUp mb-60">
                        ...
                        <p className="p-xl">
                          ...
                          neque diam dolor primis libero tempus, blandit and
                          cursus varius and magnis sodales
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col">
                    <div id="sb-1-1" className="wow fadeInUp">
                      <div className="statistic-block">
                        {/* Digit */}
                        <div className="statistic-block-digit text-center"></div>
                        {/* Text */}
                    ...
                    <div id="sb-1-2" className="wow fadeInUp">
                      <div className="statistic-block">
                        ...
                        <div className="statistic-block-digit text-center">
                          <h2 className="s-46 statistic-number"></h2>
                        </div>
                        {/* Text */}
                        <div className="statistic-block-txt color--grey">
                          <p className="p-md">
                    ...
                    <ul className="simple-list">
                      ...
                      <li className="list-item">
                        <p className="mb-0">
                          Tempor sapien quaerat an ipsum laoreet purus and
                          sapien dolor an ultrice ipsum aliquam undo congue
                          dolor cursus purus congue and ipsum purus sapien a
                          blandit
                        </p>
                      </li>
                    </ul>
                    ...
                    <div className="cbox-2 process-step">
                      ...
                      <div className="cbox-2-txt">
                        ...
                        <p className="mb-0">
                          Ligula risus auctor tempus feugiat dolor lacinia nemo
                          purus in lipsum purus sapien quaerat a primis viverra
                          tellus vitae luctus dolor ipsum n eque ligula quaerat
                        </p>
                      </div>
                    </div>{" "}
                    {/* END CONTENT BOX #3 */}
                    ...
                    <div className="questions-holder">
                      ...
                      <div className="question mb-35 wow fadeInUp">
                        ...
                        <p className="color--grey">
                          ...
                          metus and vitae arcu mollis blandit ultrice ligula
                          egestas magna suscipit lectus magna suscipit luctus
                          blandit and laoreet
                        </p>
                      </div>
                      {/* QUESTION #2 */}
                  ...
                  <div className="col-lg-6">
                    <div className="questions-holder">
                      ...
                      <div className="question mb-35 wow fadeInUp">
                        ...
                        {/* Answer */}
                        <p className="color--grey">
                          An enim nullam tempor sapien gravida donec congue
                          metus. Vitae arcu mollis blandit integer nemo volute
                          velna
                        </p>
                      </div>
                      {/* QUESTION #5 */}
                      <div className="question mb-35 wow fadeInUp">
                        ...
                        <p className="color--grey">
                          ...
                          donec neque blandit justo aliquam molestie nunc sapien
                          justo
                        </p>
                      </div>
                      {/* QUESTION #6 */}
                  ...
                  <div className="row d-flex align-items-center">
                    ...
                    <div className="col-md-7">
                      <div className="banner-13-txt color--white">
                        ...
                        {/* Text */}
                        <p className="p-lg">
                          Congue laoreet turpis neque auctor turpis vitae dolor
                          a luctus placerat and magna ligula cursus
                        </p>
                        {/* Button */}
                      </div>
                    </div>{" "}
