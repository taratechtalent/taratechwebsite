                ...
                <div className="col-md-11 col-lg-10 col-xl-9">
                  <div className="about-2-title mb-60">
                    ...
                    <p className="mb-0">
                      ...
                      porta justo integer and purus velna vitae auctor integer
                      undo congue diam purus pretium and ligula tempor primis
                      libero at tempus, blandit and cursus varius magnis at
                      sapien egestas purus vitae purus an ipsum
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div id="sb-5-1" className="wow fadeInUp">
                      <div className="statistic-block">
                        ...
                        <div className="statistic-txt">
                          ...
                          <p>
                            Porta justo integer and velna vitae auctor and magna
                            quaerat ligula
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="col">
                    <div id="sb-5-3" className="wow fadeInUp">
                      <div className="statistic-block">
                        ...
                        <div className="statistic-digit">
                          <h2 className="s-44 w-700">
                            <CounterUp end={4} />.<CounterUp end={87} />
                            /5
                          </h2>
                        </div>
                        {/* Text */}
                  ...
                  <div className="col">
                    <div className="team-member mb-50 wow fadeInUp">
                      ...
                      <div className="team-member-data">
                        <h6 className="s-20 w-700 color--black">
                          Jonathan Barnes
                        </h6>
