              ...
              <div className="col-xl-10">
                ...
                <div className="txt-block legal-info">
                  ...
                  <p>
                    ...
                    and mollis, sapien gravida aliquet ipsum ultrices aliquet
                    lorem purus and vitae auris aliquam
                  </p>
                  {/* Text */}
                  <p>
                    ...
                    blandit fusce an aliquam nulla lacinia justo molestie
                    blandit justo diam aliquet tortor molestie non sagittis
                    lacinia
                  </p>
                  {/* Title */}
                  <h4 className="s-30 w-700">
                  ...
                  <p>
                    ...
                    massa elementum. Libero quisque lacus and ligula massa lorem
                  ...
                  {/* Title */}
                  <h4 className="s-30 w-700">
                    <span>3.</span> Service Description
                  </h4>
                  {/* Text */}
                  <p>
                  ...
                  <ul className="simple-list">
                    <li className="list-item">
                      <p>
                        ...
                        sapien gravida laoreet turpis urna augue, viverra a
                        augue eget diam pulvinar
                      </p>
                    </li>
                    <li className="list-item">
                      <p>
                  ...
                  <p>
                    ...
                    purus justo lacus ligula ipsum primis cubilia donec undo
                    augue luctus vitae egestas a molestie donec libero sapien
                    dapibus congue tempor undo quisque fusce cursus neque diam
                    augue fusce sapien nulla a primis lacinia ipsum a molestie
                    blandit and justo an aliquet eget molestie sagittis at
                    quaerat sodales
                  </p>
                  {/* Text */}
                  <p>
                    Aliqum mullam tincidunt a sapien gravida and diam donec
                    porta.
                  </p>
                  {/* Title */}
                  <h4 className="s-30 w-700">
                    <span>4.</span> Account Information
                  </h4>
                  {/* Text */}
                  <p>
                    Sagittis congue augue egestas integer velna purus purus
                  ...
                  {/* Small Title */}
                  <h5 className="s-24 w-700">
                    <span>4.1.</span> Registering for an account
                  </h5>
                  {/* Text */}
                  <p>
                    Congue augue sagittis egestas integer velna purus purus
                  ...
                  {/* Small Title */}
                  <h5 className="s-24 w-700">
                    <span>4.2.</span> Your responsibility for your account
                  </h5>
                  {/* Text */}
                  <p>
                    Integer congue sagittis augue egestas velna purus purus
                  ...
                  {/* Text */}
                  <p>
                    Augue congue sagittis egestas integer velna purus purus
                    magna nec suscipit and egestas magna aliquam ipsum vitae
                    purus justo lacus ligula ipsum primis cubilia donec undo
                    augue luctus vitae egestas a molestie donec libero sapien
                    dapibus congue tempor undo quisque fusce cursus neque donec
                    and ipsum porta diam lorem sodales an aliquam lacinia justo
                    sapien congue aliquet and sodales a quaerat tortor lacinia
                    egestas
                  </p>
                  {/* Title */}
                  <h4 className="s-30 w-700">
                    <span>6.</span> Method of Payment
                  </h4>
                  {/* Text */}
                  <p>
                    Integer congue sagittis augue egestas velna purus purus
                  ...
                  <p>
                    Sagittis augue congue egestas integer velna purus purus
                    magna nec suscipit and egestas magna aliquam ipsum vitae
                    purus justo lacus ligula ipsum primis cubilia donec and
                    augue luctus congue
                  </p>
                  {/* Small Title */}
                  <h5 className="s-24 w-700">
                    <span>6.1.</span> Refunds
                  </h5>
                  {/* Text */}
                  <p>
                    Integer congue sagittis augue egestas velna purus purus
                  ...
                  {/* Title */}
                  <h4 className="s-30 w-700">
                    <span>8.</span> Changes to This Terms of Service
                  </h4>
                  {/* Text */}
                  <p>
                    Congue augue sagittis egestas integer velna purus purus
