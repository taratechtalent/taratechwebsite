                    ...
                    <div className="row d-flex align-items-center">
                      ...
                      <div className="col-md-6 order-last order-md-2">
                        <div className="txt-block left-column wow fadeInRight">
                          {/* Section ID */}
                          {/* Title */}
                          <h2 className="s-46 w-700">AI/Machine Learning</h2>
                          {/* Text */}
                          <p>
                            AI/Machine Learning is a field of computer science
                            that focuses on creating systems that learn from
                            data and improve their performance over time. This
                            section introduces the concepts of AI and machine
                      ...
                      <div className="col-md-6 order-first order-md-2">
                        <div className="img-block right-column wow fadeInLeft">
                          <img
                            className="img-fluid"
                            src="/images/services/internals/ai machine learning.png"
                            alt="content-image"
                            style={{
                              borderRadius: "15px",
                      ...
                      <div className="row">
                        <div className="col text-center mb-32">
                          ...
                          <p className="s-21 color--grey mt-6">
                            Navigating the Ethical Landscape and Embracing{" "}
                            {`AI's`} Evolution
                          </p>
                        </div>
                      </div>
