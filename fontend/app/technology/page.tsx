                  ...
                  <div className="col-md-6">
                    <div className="blog-post-img">
                      <img
                        ...
                        src="/images/blog/post-11-img.jpg"
                        alt="blog-post-image"
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="blog-post-txt">
                      ...
                      <h3 className="s-38 w-700">
                        <Link href="/blog/single">Techbnology</Link>
                      </h3>
                      {/* Text */}
                      <p>Techbnology</p>
                      {/* Post Meta */}
                  ...
                  <div className="col-md-12 col-lg-4">
                    <div className="blog-post mb-40 wow fadeInUp clearfix">
                      ...
                      <div className="blog-post-txt">
                        ...
                        {/* Text */}
                        <p>
                          Mullam ipsum aliqum vitae and blandit vitae tempor
                      ...
                      <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 order-last order-md-2">
                          <div className="blog-post-txt color--white">
                            ...
                            {/* Text */}
                            <p>
                              Aliqum mullam blandit vitae and tempor sapien and
                              donec lipsum gravida porta undo velna dolor libero
                        ...
                        <div className="col-md-6 order-first order-md-2">
                          <div className="blog-post-img video-preview">
                            ...
                            <img
                              className="img-fluid"
                              src="/images/blog/post-10-img.jpg"
                              alt="video-preview"
                            />
                          </div>
                        </div>
                  ...
                  <div className="col-md-12 col-lg-4">
                    <div className="blog-post mb-40 wow fadeInUp clearfix">
                      ...
                      <div className="blog-post-img mb-35">
                        <img
                          className="img-fluid r-16"
                          src="/images/blog/post-9-img.jpg"
                          alt="blog-post-image"
                        />
                      </div>
                      {/* BLOG POST TEXT */}
